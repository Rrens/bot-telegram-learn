...
def log_bot(update: Update, perintah):
    ...
    if check_swfm is True:
        ...
        if handle_no_link == '[]':
            ...
            print(f"PROBLEM NOTE IKI {problem_note}")
            problem_note = problem_note.split('\\n')[0]
            print(f"PROBLEM NOTE AFTER IKI {problem_note}")
            problem__ = str(data[15]).replace('\\n',' ')
            date = str(data[18]).replace('-',' ')
            category = str(tools)
            print(f"INI DATA SELECT {data_select}")
            
            print('bener')
            print(problem_note.split('\\n')[0])
            
            if data_select == 'BPS Manual': # sudah
            ...
            elif data_select == 'Preventive Maintenance': # sudah
                data_cat = str(data_select1).split(' ➞ ')[1]
                data_cat = data_cat.split('\\n')[0]
                print(f"DATA CAT {data_cat}")
                if data_cat == 'Schedule Planning':
                    ...
                    update.message.reply_text(f'*{full_name}* has open ticket with the following details:\n\nCreation Date : {date}\nApplication : #{category}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nRegional : {regional}\nSOP Link : https://bit.ly/swfm-pm-schedule-planning\nHandle by : {handle_no_link}\n\nMohon bantuan kak [{full_name}]({requests}), untuk melengkapi *nomor tiket, screenshoot, evidence problem atau eror* pada room diskusi !!!',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
        ...
        if os.path.exists("/home/dimas/baru/helpdeskbot_v2/data_log/log_expert.txt"):
            ...
            data_expert = str(data_expert).replace("['","").replace("']","").split('\\n')
            count_expert = len(data_expert)
            print(f"INI DATA EXPERT = {data_expert} ||| INI COUNT EXPERT = {count_expert}")
            if data_expert[0] == '' :
                query = f"select * from production.helpdesk_bot_swfm where chatid_telegram = '{chatid_telegram}'"
                data = client.command(query)
                full_name = str(data[0]).title()
        ...
        if os.path.exists("/home/dimas/baru/helpdeskbot_v2/data_log/log_expert.txt"):
            ...
            data_expert = str(data_expert).replace("['","").replace("']","").split('\\n')
            count_expert = len(data_expert)
            print(f"DATA EXPERT = == = = = === == === = = {data_expert} AND COUNT EXPERT {count_expert}")
            if data_expert[0] == '' :
                query = f"select * from production.helpdesk_bot_swfm where chatid_telegram = '{chatid_telegram}'"
                data = client.command(query)
                full_name = str(data[0]).title()
                ...
                # IKII
                if data_select == 'Transport':
                    print(f"iki DATA SELECT {data_select} || LEK IKI PROBLEM NOTE {problem_note}")
                    bot_log.sendChatAction(chat_id=chatid_ipas1,action=telegram.ChatAction.TYPING)
                    update.message.reply_text(f'*{full_name}* has open ticket with the following details:\n\nCreation Date : {date}\nApplication : #{category}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nHandle by : [{to_name_1}]({to_1}), [{to_name_2}]({to_2}), [{to_name_3}]({to_3}), [{to_name_4}]({to_4}), [{to_name_5}]({to_5}), [{to_name_6}]({to_6}), [{to_name_7}]({to_7})\n\nMohon bantuan kak [{full_name}]({requests}), untuk melengkapi nomor tiket, screenshoot, evidence problem atau eror pada room diskusi !!!',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                    # data = bot_log.send_message(chat_id=chatid_ipas1,text=f'*{full_name}* has open ticket with the following details:\n\nCreation Date : {date}\nApplication : #{category}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nHandle by : [{to_name_1}]({to_1}), [{to_name_2}]({to_2}), [{to_name_3}]({to_3}), [{to_name_4}]({to_4}), [{to_name_5}]({to_5}), [{to_name_6}]({to_6}), [{to_name_7}]({to_7})\n\nMohon bantuan kak [{full_name}]({requests}), untuk melengkapi nomor tiket, screenshoot, evidence problem atau eror pada room diskusi !!!',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                elif data_select == 'Power':
                    ...
                    # data = bot_log.send_message(chat_id=chatid_ipas7,text=f'*{full_name}* has open ticket with the following details:\n\nCreation Date : {date}\nApplication : #{category}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nHandle by : [{to_name_1}]({to_1}), [{to_name_2}]({to_2}), [{to_name_3}]({to_3}), [{to_name_4}]({to_4}), [{to_name_5}]({to_5}), [{to_name_6}]({to_6}), [{to_name_7}]({to_7})\n\nMohon bantuan kak [{full_name}]({requests}), untuk melengkapi nomor tiket, screenshoot, evidence problem atau eror pada room diskusi !!!',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                    update.message.reply_text(f'*{full_name}* has open ticket with the following details:\n\nCreation Date : {date}\nApplication : #{category}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nHandle by : [{to_name_1}]({to_1}), [{to_name_2}]({to_2}), [{to_name_3}]({to_3}), [{to_name_4}]({to_4}), [{to_name_5}]({to_5}), [{to_name_6}]({to_6}), [{to_name_7}]({to_7})\n\nMohon bantuan kak [{full_name}]({requests}), untuk melengkapi nomor tiket, screenshoot, evidence problem atau eror pada room diskusi !!!',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                    # update.message.reply_chat_action(f'*{full_name}* has open ticket with the following details:\n\nCreation Date : {date}\nApplication : #{category}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nHandle by : [{to_name_1}]({to_1}), [{to_name_2}]({to_2}), [{to_name_3}]({to_3}), [{to_name_4}]({to_4}), [{to_name_5}]({to_5}), [{to_name_6}]({to_6}), [{to_name_7}]({to_7})\n\nMohon bantuan kak [{full_name}]({requests}), untuk melengkapi nomor tiket, screenshoot, evidence problem atau eror pada room diskusi !!!',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
            elif count_expert == 8:
                query = f"select * from production.helpdesk_bot_swfm where chatid_telegram = '{chatid_telegram}'"
                data = client.command(query)
                full_name = str(data[0]).title()
...
def end_scarlett(update: Update, _: CallbackContext) -> None:
    ...
    if status[0] is False:
        ...
        ticket_status = data
        ticket_status = data
        lines = ticket_status.strip().split('\n')
        unique_ticket = list(set(lines))[0]
        ticket_status = unique_ticket
...
def split_message(text, max_length):
    """Bagi pesan menjadi bagian-bagian kecil berdasarkan panjang maksimum."""
    parts = []
...
def scarlett_myticket_process(update: Update, _: CallbackContext) -> None:
    ...
    if position is True: ##ADMIN
        try:
            ...
            check_status = client.command(query)
            check_status = check_status == 0
            print(f"INI CHECK STATUS {check_status} IKI QUERY e {query}")
            if check_status is True:
                ...
                print(f"Status tiket e {data_check}")
                if data_check == 'closed':
                    ...
                    ticket = data[11]
                    regional = data[13]
                    problem_note = data[14]
                    problem_note = problem_note.split('\\n')[0]
                    problem__ = data[15].replace('\\n', ' ')
                    app = data[17]
                    date = data[18].replace('-', ' ')
                    
                    MAX_MESSAGE_LENGTH = 3096 # LIMIT TEXT TELEGRAM
                    
                    problem_parts = split_message(problem__, MAX_MESSAGE_LENGTH)
                    # print(problem_parts)
                    
                    for index, part in enumerate(problem_parts):
                        # Tentukan keterangan lanjutan
                        if index >= 1:
                            update.message.reply_text(f"*{part}*", parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                        else:
                            final_message = (f'Creation Date : {date}\n'
                                                f'Application : #{app}\n'
                                                f'Ticket : #{ticket}\n'
                                                f'Summary Case : *{problem_note} ↔️ ({part})*\n'
                                                f'Requestor : [{full_name}]({requests})\n'
                                                f'No HP : {no_hp}\n'
                                                f'Regional : {regional}\n')
                            
                            update.message.reply_text(final_message, parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                            # additional_note = "Lanjutan pesan sebelumnya..."

                        # Gabungkan bagian problem__ dengan bagian utama pesan

                    
                    # message = (
                    #     f"Creation Date : {date}\nApplication : #{app}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nRegional : {regional}"
                    # )

                    
                    # if(len(problem__) > 1000):
                    #     print('oke')
                    #     message_split = (
                    #         f"Creation Date : {date}\nApplication : #{app}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests[:1000]})\nNo HP : {no_hp}\nRegional : {regional}"
                    #     )
                        
                    #     message_split_2 = f'*Continuation of the Problem:* ({problem__[1000:]})'
                        
                    #     update.message.reply_text(message_split,parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                    #     update.message.reply_text(message_split_2,parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                    # else:
                    #     update.message.reply_text(message,parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
                    ...
                    # update.message.reply_text('testing',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
...
def end_ioms(update: Update, _: CallbackContext) -> None:
    ...
    if status[0] is False:
        ...
        # data_select[14] = 'Aplication Error ➞ Loading after Login'
        ...
        # print(f"IKI STATUS ================== {status} ============= IKI DATA SELECT {data_select[14]} ==== DAN HASIL E NGENE {problem_title_insert}")
        ...
        try:
            ...
            if check_status is True:
                ...
                if data_check == 'closed':
                    ...
                    app = data[17]
                    date = str(data[18]).replace('-',' ')
                    print(f"problem note {problem_note}")
                    print(f"problem__ {problem__}")
                    update.message.reply_text(f'Creation Date : {date}\nApplication : #{app}\nTicket : #{ticket}\nSummary Case : *{problem_note} ↔️ ({problem__})*\nRequestor : [{full_name}]({requests})\nNo HP : {no_hp}\nRegional : {regional}',parse_mode=telegram.ParseMode.MARKDOWN, disable_web_page_preview=True)
...
def end_ipas(update: Update, _: CallbackContext) -> None:
    ...
    query = f"select * from production.helpdesk_bot_swfm where chatid_telegram = '{chatid_telegram}'"
    data = client.command(query)
    print(f"IKI DATA 3 {data[3]}")
    val_check_ticket = data[3] == ticket
    problem_title = str(data[14]).split(' ➞ ')[0]
    problem_title = problem_title.split('\\n')[0]
    print(f"PROBLEM TITLE IKI LUR {problem_title}")
    status.append(val_check_ticket)
    print(f"IKI TIKET {status} DAN IKI TIKET {ticket} IKI PROBLEM TITLE {problem_title}")
    if status[0] is False:
        data_select = problem_title
        if data_select == 'Transport':
        ...
        data_select[14] = problem_title_insert
        print(f"IKI DATA SELECT 14 {data_select[14]}")
        print(f"IKI TIKET 11 {data_select[11]}")
        query = f"INSERT INTO production.helpdesk_report_swfm select '{data_select[0]}','{data_select[1]}','{data_select[2]}','{data_select[3]}','{data_select[4]}','{data_select[5]}','{data_select[6]}','{data_select[7]}','{data_select[8]}','{data_select[9]}','{data_select[10]}','{data_select[11]}','{data_select[12]}','{data_select[13]}','{data_select[14]}','{data_select[15]}','{data_select[16]}','{data_select[17]}','{data_select[18]}','{data_select[19]}','{data_select[20]}','{data_select[21]}','{data_select[22]}','{data_select[23]}','{data_select[24]}','{data_select[25]}'"
        client.command(query)
        time.sleep(2)
        ...
        check_count = client.command(query)
        check_count = check_count == 0
        print(f"CEK COUNT {check_count} DATA SELECT {data_select}")
        if check_count is True:
            username_expert = 'https://t.me/puang_ocha'
            client = clickhouse_connect.get_client(database="production",host='10.54.18.55', port=8123, username='app_aam_dashboard', password='AAMDashboard#2024')
            query = f"select problem_title from production.helpdesk_bot_swfm where chatid_telegram = '{chatid_telegram}'"
...
def end_swfm(update: Update, _: CallbackContext) -> None:
    ...
    problem_title = str(data[14]).split(' ➞ ')[0]
    problem_title = problem_title.split('\\n')[0]
    print(f'IKI PROBLEM TITLE SWFM {problem_title}')
    status.append(val_check_ticket)
    if status[0] is False:
        data_select = problem_title
        data_select = data_select.split('\\n')[0]
        ...
        print(f"DATA SELECT 14 {data_select[14]}")
        query = f"INSERT INTO production.helpdesk_report_swfm select '{data_select[0]}','{data_select[1]}','{data_select[2]}','{data_select[3]}','{data_select[4]}','{data_select[5]}','{data_select[6]}','{data_select[7]}','{data_select[8]}','{data_select[9]}','{data_select[10]}','{data_select[11]}','{data_select[12]}','{data_select[13]}','{data_select[14]}','{data_select[15]}','{data_select[16]}','{data_select[17]}','{data_select[18]}','{data_select[19]}','{data_select[20]}','{data_select[21]}','{data_select[22]}','{data_select[23]}','{data_select[24]}','{data_select[25]}'"
        client.command(query)
        time.sleep(2)
        ...
        check_count = client.command(query)
        print(f"CEK COUNT LUR {check_count}  DAN IKI CHECK COUNT TRUE OPO GAK {check_count is True}")
        check_count = check_count == 0
        ...
        if check_count is True:
            ...
            print(f"DATA SELECT CHECK COUNT TRUE = {data_select}")
            if data_select == 'BPS Manual':
...
def swfm_download_excel(update: Update, _: CallbackContext) -> None: 
    ...
    for data in data_list:
        ...
        # dub_data = {'Nama': f'{data[0]}', 'Username Telegram': f'{data[1]}', 'Chatid Telegram': f'{data[2]}', 'No HP': f'{data[3]}', 'Email': f'{data[4]}', 'Remark': f'{data[5]}', 'Position' : f'{data[9]}', 'Channel Chatid': f'{data[10]}', 'Ticket': f'{data[11]}', 'Divison': f'{data[12]}', 'Regional': f'{data[13]}', 'Problem Title': f'{data[14]}', 'Problem Summary': f'{data[15]}', 'Status': f'{data[16]}', 'Category': f'{data[17]}', 'Open Ticket Date': f'{data[18]}, {data[19]}', 'Closed Ticket Date': f'{data[20]},{data[21]}', 'FCAPS': f'{data[22]}', 'Action Menu': f'{data[23]}', 'Action Category': f'{data[24]}', 'Action Handle By': f'{data[25]}', 'Action Resolution': f'{data[26]}', 'Post Link': f'{data[27]}'}
        dub_data = {
            'Nama': data[0] if len(data) > 0 else '',
            'Username Telegram': data[1] if len(data) > 1 else '',
            'Chatid Telegram': data[2] if len(data) > 2 else '',
            'No HP': data[3] if len(data) > 3 else '',
            'Email': data[4] if len(data) > 4 else '',
            'Remark': data[5] if len(data) > 5 else '',
            'Position': data[9] if len(data) > 9 else '',
            'Channel Chatid': data[10] if len(data) > 10 else '',
            'Ticket': data[11] if len(data) > 11 else '',
            'Divison': data[12] if len(data) > 12 else '',
            'Regional': data[13] if len(data) > 13 else '',
            'Problem Title': data[14] if len(data) > 14 else '',
            'Problem Summary': data[15] if len(data) > 15 else '',
            'Status': data[16] if len(data) > 16 else '',
            'Category': data[17] if len(data) > 17 else '',
            'Open Ticket Date': f'{data[18]}, {data[19]}' if len(data) > 19 else '',
            'Closed Ticket Date': f'{data[20]}, {data[21]}' if len(data) > 21 else '',
            'FCAPS': data[22] if len(data) > 22 else '',
            'Action Menu': data[23] if len(data) > 23 else '',
            'Action Category': data[24] if len(data) > 24 else '',
            'Action Handle By': data[25] if len(data) > 25 else '',
            'Action Resolution': data[26] if len(data) > 26 else '',
            'Post Link': data[27] if len(data) > 27 else ''
        }
        # print(f"INI DATANYA: {dub_data}")
        array_data1.append(dub_data)
